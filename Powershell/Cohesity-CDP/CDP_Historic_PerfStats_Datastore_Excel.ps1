#Variables - This should be changed to match your configuration
    ...
    $TempCSVlocation = "C:\Users\wkhan\Desktop\pcli_out\CDPPerformance.csv"
    $ExcelFileLocation = "C:\Users\wkhan\Desktop\pcli_out\CDPPerformance_$(Get-Date -Format 'yyyy_MM_dd').xlsx"
